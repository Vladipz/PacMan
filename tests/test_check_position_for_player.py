...
@pytest.mark.parametrize("center_x, center_y, direction, expected_turns", [
    (73, 74, 3, [False, False, True, False]),
    (39, 40, 1, [True, False, False, False]),
    (113, 104, 2, [False, False, False, False])
])
def test_check_position(maze_with_huge_map, center_x, center_y, direction, expected_turns):

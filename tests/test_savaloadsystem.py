...
import pytest
import json
from save_load_manager import SavaLoadSystem  # Replace 'your_module_name' with the actual module name
...
def test_load_default_value(save_load_system):
    ...
    loaded_data = save_load_system.load('non_existing_file', default_value=default_value)
